...
parser.add_argument('--batch_size', '-b', default=6, type=int, help='mini-batch size')
parser.add_argument('--epochs', '-e', default=25, type=int, help='number of total epochs to run')
...
parser.add_argument('--dataset', type=str, default='monet2photo', choices=['summer2winter_yosemite', 'horse2zebra','monet2photo'])
parser.add_argument('--task', type=str, default='B2A', choices=['A2B', 'B2A'])
